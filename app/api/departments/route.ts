...
export async function GET(request: NextRequest) {
  try {
    ...
    if (process.env.NODE_ENV === 'development') {
      ...
      { id: 2, name: 'Fluoroscopy Studies', allows_home_service: false, max_concurrency: 3, description: 'Real-time X-ray imaging for diagnostic procedures.' },
      { id: 3, name: 'Mammogram', allows_home_service: false, max_concurrency: 3, description: 'Breast imaging for cancer screening and diagnosis.' },
      ...
      { id: 6, name: 'MRI & CT Scan', allows_home_service: false, max_concurrency: 3, description: 'Advanced imaging for internal structures and organs.' },
